...
const App = () => {
  ...
  return (
    <Router className="h-screen w-full">
      <div>
        <Header />
        <Routes>
          ...
          <Route path="/add-recipe" element={<AddRecipeForm userAuth={userAuth} />} />
          <Route path="/recipe-list" element={ <RecipeList userAuth={userAuth} />} />
          <Route path="/user/:authorId" element={<RecipeUser user={user}/>} />
          <Route path="/recipes/:id" element={<RecipeDetail user={user} />} />
          <Route path="/recomen" element={<RecommendationRecipes user={user} />} />
          ...
          <Route path="/recipes/edit/:id" element={<EditRecipePage  user={user} />} />
        </Routes>
        <Footer />
      </div>
    </Router>

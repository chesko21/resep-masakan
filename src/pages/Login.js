...
const Login = () => {
  ...
  return (
    <div className="flex flex-col items-center text-center h-screen">
      <h2 className="text-3xl font-bold mb-6 animate__animated animate__fadeIn">Login</h2>
      ...
      <form onSubmit={handleLogin} className="flex flex-col items-center">
        ...
        <div className="mb-4">
          <label htmlFor="password" className="flex mr-2 mb-2 font-semibold">Password:</label>
      ...
      <p className="mt-4 animate__animated animate__fadeIn">
        Not registered? <Link to="/signup" className="text-blue-500">Signup</Link>
             </p>
      <button
      ...
      <button className="flex mt-2 text-blue-500 hover:underline animate__animated animate__fadeIn" onClick={handleForgotPassword}>
        Forgot Password?
      </button>
      {/* Modal */}
      {showModal && (
        <div className="fixed inset-0 flex items-center justify-center z-50">
          <div className="bg-white p-4 rounded-lg shadow-lg animate__animated animate__fadeIn">
            <p className="text-green-500 text-lg font-semibold mb-2">Login Successful!</p>
